                    ...
                    <div className="accordion-item">
                        ...
                        <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                <strong>Props and State :</strong> Props are used to pass data from one component to another and props are read only and cannot be changed. On the otherhand state is a local data storage that is local to the component only.
                            </div>
                        </div>
                    </div>
                    <div className="accordion-item">
